  ...
  return (
    <div className="landing-page-gradient-1 relative flex h-max w-screen flex-col items-center font-lora ">
      <div className="absolute right-4 top-4">
        <a href="https://www.tryrapidly.com/" target="_blank">
          <button className="flex items-center justify-center font-nunito text-lg font-bold ">
            Built by Rapidly
            <img src="logo.png" className="mx-2 rounded-lg" width={40} />
          </button>
        </a>
      </div>
      <div className="mt-28 flex flex-col items-center">
        <div className="w-4/5 text-center text-4xl">
          Empower your organization&apos;s Business Intelligence with Access To All{" "}
          <span className="font-bold">BUSINESS KNOWLEDGE & DOCUMENTATION</span>
        </div>
        <div className="mt-4 flex items-center justify-center">
          <div className="w-3/5 text-center font-nunito">
            Effortlessly integrate your business knowledge and documentation and enable non-data professionals to interact with, and derive value from, their company’s data-centric projects
          </div>
        </div>
        <div className="mt-4 flex items-center justify-center">
          <GitHubButton href="https://github.com/run-llama/sec-insights"></GitHubButton>
        </div>
      </div>
      {isMobile ? (
        ...
        <div className="mt-5 flex h-min w-11/12 max-w-[1200px] flex-col items-center justify-center rounded-lg border-2 bg-white sm:h-[400px] md:w-9/12 ">
          <div className="p-4 text-center text-xl font-bold">
            Search your knowledge basis with our integrations
          </div>
